    ...
    for ngram in acronymNgrams: # language model, filtered by ngrams containing acronyms
        ...
        if not ngram.isupper() and not NEWLINE in ngram and count % div == 0: # and ngram.count(" ") < 3:
            ...
            for s in splits:
                ...
                liCorpus = get_synonyms_from_ngrams.findEmbeddings(leftString, acronym, rightString, ngramstat, index, minWinSize, minfreq, maxcount, minNumberTokens, maxNumberTokens, False)
