...
def test_WordNgramStat():
    ...
    assert ling.WordNgramStat('a b', 1, 1) == {'a': 1, 'b': 1}
    assert ling.WordNgramStat('a a', 1, 1) == {'a': 2}
    assert ling.WordNgramStat('a b', 1, 2) == {'a': 1, 'b': 1, 'a b': 1}

    assert ling.WordNgramStat('a ab aa a a a ba ddd', 1, 4) == {'a': 4, 'ab': 1, 'aa': 1, 'ba': 1, 'ddd': 1, 'a ab': 1,
